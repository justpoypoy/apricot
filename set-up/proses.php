...
$hashpassword = new PasswordHash(8, false);
if (file_exists("../starting") AND isset($_POST['nama_database'])) {
    ...
    $password_user = $hashpassword->HashPassword($_POST['password_user']);
    $base_url = $_POST['base_url'];
    $directory = $_POST['directory'];
    $admin = $_POST['folder_admin'];
...
//update
    $pdo->query("UPDATE informasi SET nama='$nama_website' WHERE id='1' ");
    $pdo->query("UPDATE user SET name_user='$nama_user_login', nama_lengkap='$nama_user', password_user='$password_user', avatar_user='default.jpg' WHERE id_user='1' ");
