                    ...
                    <div class="row" style="padding: 20px">
                        <div class='col-md-12'>
                            ...
                            <div class="form-informasi" style="display: none">
                                ...
                                <div class="form-group">
                                    <label>Directory Folder Admin (default: admin)</label>
                                    <input type="text" class="form-control" id="folder_admin" value="<?php echo 'admin'; ?>" />
                                </div>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $(document).on("click", "#setting-informasi", function () {
                    ...
                    folder_admin = $("#folder_admin").val().toLowerCase();
                    ...
                    if (!_this[0].memproses) {
                        ...
                        } else if (!/^[\w]+$/.test(folder_admin)) {
                            alert("Hanya diperbolehkan huruf, angka dan underscore");
                            _this[0].memproses = false;
                            $("#folder_admin").focus();
                        } else if (folder_admin === "") {
                            alert("Masukkan nama directory admin");
                            _this[0].memproses = false;
                            $("#folder_admin").focus();
                        } else {
                            _this.html("Memproses...");
